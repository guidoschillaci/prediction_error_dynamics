...
class Parameters:
    ...
    def __init__(self):
        self.dictionary = {
            ...
            'im_mse_buffer_size': 1, # initial size of the mean squared error buffer (should be bigger than max PE_buffer_size
            'im_movements_buffer_size': 10, # buffer size of the movement amplitudeds
